 ...
 *         try to get the instance of the Singleton class simultaneously. So
 *         Bill Pugh came up with a different approach to create the Singleton
 *         class using an inner static helper class. The Bill Pugh Singleton
...
public class E_BillPughSingleton {
	 ...
	 * synchronization. I am using this approach in many of my projects and it’s
	 * easy to understand and implement also.
	 */
}
